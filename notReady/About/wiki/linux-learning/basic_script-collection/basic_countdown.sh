...
:'
This is a simple skeleton of a bash countdown script. The script takes two arguments . 
...
Do not forget to make basic_countdown.sh script executable before execution:
$ chmod +x countdown.sh

Exectute:
$ ./basic_countdown.sh -d 08:50'

 
if [ "$#" -lt "2" ] ; then 
	echo "Incorrect usage ! Example:" 
	echo './basic_countdown.sh -d  "Jun 10 2011 16:06"' 
	echo 'or' 
